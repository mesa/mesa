...
# Reporter values of these types are stored directly instead of deepcopied,
# because they cannot contain anything that a later mutation could reach.
# tuple is deliberately excluded: it is only shallowly immutable and may hold
# mutable objects such as lists, so it still needs a deepcopy to keep already
# collected records frozen.
_PYTHON_IMMUTABLE_TYPES = (str, int, bool, float)
    ...
    def _record_agents(self, model):
        ...
        def get_reports(agent):
            ...
            for rep in rep_funcs:
                ...
                if isinstance(value, _PYTHON_IMMUTABLE_TYPES):
