...
"""
    ...
    print(f"Optimization Score: {result['optimization_report']['optimization_score']}/100")
    print(f"Found {result['optimization_report']['total_opportunities']} optimization opportunities")
