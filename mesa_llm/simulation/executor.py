...
class SafeExecutor:
    ...
    def execute_code(
        self, code: str, capture_output: bool = True, timeout: int | None = None
    ) -> dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "globals": {
                    k: v
                    for k, v in execution_globals.items()
        ...
        try:
            ...
            if not model_classes and not model_instances:
                ...
                validation_result["suggestions"].append(
                    "No Mesa Model class or instance found"
                )
...
"""
    ...
    def _validate_code_safety(self, code: str) -> dict[str, Any]:
        ...
        try:
            ...
            return {"is_safe": False, "reason": f"Syntax error: {e!s}"}
            ...
            if isinstance(node, (ast.Import, ast.ImportFrom)):
                ...
                for module_name in module_names:
                    if module_name and not any(
                        allowed in module_name for allowed in self.allowed_imports
                    ):
    ...
    def _create_safe_globals(self) -> dict[str, Any]:
        ...
        restricted_builtins = {
            name: __builtins__[name] for name in safe_builtins if name in __builtins__
        }

        return {"__builtins__": restricted_builtins, "__name__": "__main__"}
    ...
    def _set_resource_limits(self):
        ...
        try:
            ...
            # Set CPU time limit
            resource.setrlimit(
                resource.RLIMIT_CPU, (self.max_execution_time, self.max_execution_time)
            )
