...
class PromptManager:
    ...
    def get_debug_prompt(self, code: str, error_message: Optional[str] = None) -> str:
    ...
    def get_explanation_prompt(self, code: str, focus_area: Optional[str] = None) -> str:
        """Get explanation prompt for describing simulations."""
        prompt = f"Explain this Mesa simulation in simple terms:\n\n```python\n{code}\n```"
    ...
    def get_optimization_prompt(self, code: str, performance_issues: Optional[str] = None) -> str:
    ...
    def _classify_simulation_type(self, user_prompt: str) -> SimulationType:
        ...
        predator_prey_keywords = [
            "predator", "prey", "wolf", "sheep", "hunt", "eat", "food chain",
            "ecosystem", "population dynamics", "species"
        ]
        
        social_keywords = [
            "social", "opinion", "influence", "network", "community", "culture",
            "segregation", "schelling", "voter", "consensus", "polarization"
        ]
        
        economic_keywords = [
            "economic", "market", "trade", "wealth", "money", "price", "supply",
            "demand", "auction", "exchange", "financial", "economy"
        ]
