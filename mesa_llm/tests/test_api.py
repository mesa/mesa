...
class TestAPIEndpoints:
    ...
    def test_generate_simulation_success(self, mock_generator_class, client):
        ...
        # Mock the generator
        mock_generator = Mock()
        mock_generator.generate_simulation = AsyncMock(
            return_value={
        ...
        response = client.post(
            "/api/v1/generate",
            json={"prompt": "Create a simple agent model", "llm_provider": "openai"},
        )
    ...
    def test_debug_code_success(self, mock_debugger_class, client):
        ...
        # Mock the debugger
        mock_debugger = Mock()
        mock_debugger.debug_code = AsyncMock(
            return_value={
    ...
    def test_explain_code_success(self, mock_explainer_class, client):
        ...
        # Mock the explainer
        mock_explainer = Mock()
        mock_explainer.explain_simulation = AsyncMock(
            return_value={
                "explanation": {
    ...
    def test_optimize_code_success(self, mock_optimizer_class, client):
        ...
        # Mock the optimizer
        mock_optimizer = Mock()
        mock_optimizer.optimize_simulation = AsyncMock(
            return_value={
                "optimization_report": {
                ...
                "llm_optimization": {
                    "optimization_suggestions": "Code is well optimized"
                },
            }
        )
    ...
    def test_execute_code_success(self, mock_executor_class, client):
        ...
        # Mock the executor
        mock_executor = Mock()
        mock_executor.run_simulation_steps = Mock(
            return_value={
                "success": True,
    ...
    def test_invalid_request_data(self, client):
        ...
        response = client.post("/api/v1/generate", json={"invalid_field": "test"})
